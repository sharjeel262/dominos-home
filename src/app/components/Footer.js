    ...
    <footer className="relative bg-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center gap-4 mb-8">
          ...
          <div className="flex gap-4 mt-2">
            <span>
              <Image src="/iphone.webp" alt="App Store" width={140} height={42} />
            </span>
            <span>
      ...
      {showTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#007FAA] hover:bg-[#00596e] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition"
